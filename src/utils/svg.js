export const DirectionIcon = ({ width, height, className }) => {
  return (
    <svg
...
export const LogoutIcon = ({ width, height, className }) => {
  return (
    <svg
      ...
      height={height ?? "16"}
      fill="currentColor"
      className={className ? `${className} "bi bi-escape"` : "bi bi-escape"}
      viewBox="0 0 16 16"
    >
...
export const ProfileIcon = ({ width, height, className }) => {
  return (
    <svg
      ...
      fill="currentColor"
      className={
        className ? `${className} "bi bi-person-fill"` : "bi bi-person-fill"
      }
      viewBox="0 0 16 16"
    >
...
export const SingInIcon = ({ width, height, className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width ?? "16"}
...
export const WhatsAppIcon = ({ width, height, className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width ?? "16"}
      height={height ?? "16"}
      fill="currentColor"
      className={className ? `${className} "bi bi-whatsapp"` : "bi bi-whatsapp"}
      viewBox="0 0 16 16"
    >
...
export const FacebookIcon = ({ width, height, className }) => {
  return (
    <svg
      ...
      height={height ?? "16"}
      fill="currentColor"
      className={className ? `${className} "bi bi-facebook"` : "bi bi-facebook"}
      viewBox="0 0 16 16"
    >
...
export const EmailIcon = ({ width, height, className }) => {
  return (
    <svg
      ...
      height={height ?? "16"}
      fill="currentColor"
      className={className ? `${className} "bi bi-envelope"` : "bi bi-envelope"}
      viewBox="0 0 16 16"
    >
...
export const PhoneIcon = ({ width, height, className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width ?? "16"}
...
export const SaveIcon = ({ width, height, className }) => {
  return (
    <svg
      ...
      height={height ?? "16"}
      fill="currentColor"
      className={className ? `${className} "bi bi-floppy"` : "bi bi-floppy"}
      viewBox="0 0 16 16"
    >
      <path d="M11 2H9v3h2z" />
