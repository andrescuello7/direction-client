            ...
            {usuario.celular !== undefined &&
              <div className="PortadaEmail">
                <div className="d-flex">
                  ...
                  <p className="pl-2"><b>Email:</b> {usuario.email}</p>
                </div>
                {usuario.celular !== undefined && <div className="d-flex">
                  ...
                  <p className="pl-2"><b>Celu:</b>  {usuario.celular}</p>
                </div>}
                {usuario.facebook !== undefined && <div className="d-flex">
                  ...
                  <p className="pl-2"><b>Face:</b>  {usuario.facebook}</p>
                </div>}
                <div>
                  <Button variant="outline-secondary" className="w-50" onClick={handleShow}>
                    <b>Editar</b>
                  </Button>
                </div>
              </div>}
      ...
      <div>
        <Form>
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Footer>
              <Button className="mx-2 w-100 btn btn-primary" onClick={onChangeDate}>
                Guardar Cambios
              </Button>
            </Modal.Footer>
          </Modal>
